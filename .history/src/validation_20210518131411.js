...
const itemValidation = element => {
    const errorMessage = inputWrapper.querySelectorAll('.error-message');
    console.log(element.previousSibling.innerHTML);
};
