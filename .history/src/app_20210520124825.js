...
inputWrapper.addEventListener('click', event => {
    ...
    if(event.target.classList.contains('required')) {
        ...
        if(checkRequired.checked) {
            requiredObject['required'] = 'required';
            console.log(requiredObject);
            localStorage.setItem('requiredObject["required"]', requiredObject);
        }
    }
    ...
    if(event.target.tagName == 'BUTTON') {
        ...
        const requiredObject = localStorage.getItem('required');
        console.log(requiredObject)
        console.log({...inputObject, requiredObject})
