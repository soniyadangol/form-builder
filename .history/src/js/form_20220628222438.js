...
import { checkFormControl, formValidation } from "./validation";
...
export const newForm = (data => {
    ...
    mainForm.addEventListener('submit', event => {
        ...
        onMainFormSubmit(data, event);
    });
});


function onMainFormSubmit(data, event) {
    console.log(event.target.querySelectorAll('.form-control'));
    checkValidInput(tabularObject, data);
    // let isFormControlValid = checkFormControl(event.target)
    // let isFormControlValid = checkFormControl
