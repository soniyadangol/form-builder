...
export const addValidationOnKeyUp = input => {
    ...
    let requiredValue = input.getAttribute('mandatory').value;
    ...
    input.addEventListener('keyup', event => {
        switch(true) {
            ...
            case input.getAttribute('mandatory') == 'true' && maxValue && input.value.length > maxValue:
                addValidation(input);
                break;

            case input.getAttribute('mandatory') == 'true' && minValue && input.value.length < minValue:
                addValidation(input);
                break;
