import { editInputType } from './input-type';
import { cCheckBox, cToggleSwitch, cSelect, cButton, cHeadingSecondary, cRadioButton } from './shared';
...
function stateHandlerForEditItem(value, event, list) {
    ...
    const required = editInputWrapper.querySelector('.required');
