import { cButton, cCheckBox, fetchStepper, cSelect, cToggleSwitch } from "./shared";
import { debounce, checkFormControl } from "./validation";
...
const checkSelectedItem = () => {
    const checkboxWrapper = form.querySelectorAll('.checkbox-wrapper');
    let obj = {};
...
const checkSelectedRadioItem = () => {
    const radioWrapper = form.querySelectorAll('.radio-wrapper');
    let obj = {};
...
const checkSwitchState = () => {
    const togglebtns = form.querySelectorAll('.switch input[type="checkbox"]');
...
export const newForm = (data => {
    ...
    const mainForm = form.querySelector('.new-form');
