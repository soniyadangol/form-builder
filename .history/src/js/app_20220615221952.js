...
function stateHandlerForAddItem() {
    ...
    showInputValueOnDom(formObject, event);
}
...
function stateHandlerEditButton() {
...
export function showEditedValueonDom(selectedField, list) {
    ...
    stateHandlerForListItem(selectedField);
}
...
export const showInputValueOnDom = ((value, event) => {
    ...
    stateHandlerEditButton(value, event);
});
