...
const isBetween = (length, min, max, mandatoryValue) => (length < min || length > max) && mandatoryValue == 'true' ? false : true;
...
export const checkFormControl = (input) => {
    ...
    else if(!isBetween(value.length, minValue, maxValue, mandatoryValue)) {
