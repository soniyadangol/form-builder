        ...
        editButton.addEventListener('click', (e) => {
            ...
            if(editItem) {
                editItem.addEventListener('click', function(event) {
                    stateHandlerForEditItem(value, event, list);
                })
            }
        })
    }
...
export function showEditedValueonDom(selectedField, event) {
    ...
    stateHandlerForListItem(selectedField, event);
}

// show object value on dom
export const showInputValueOnDom = ((value, event) => {
    const listWrapper = document.querySelector('.list-wrapper');
    ...
    stateHandlerForListItem(value, event);
});
