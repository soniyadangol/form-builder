    ...
    switch(value.type) {
        ...
        case 'checkbox':
            for(let property in value) {
                console.log(property + 'asdf' + Object.values(value))
            }
            html = `
                <input type="checkbox" id="${value.name}" name="${value.name}" value="${value.name}">
                <label for="${value.name}"> ${value.value}</label><br>
            `;
            listWrapper.innerHTML += html;
            break;
