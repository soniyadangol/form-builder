...
const inputValueToObject = (input => {
    for(let inputValue in input.value) {
    ...
    // inputValue.push(input.value);
    // inputValue = {
    //     label: inputWrapper.label.value,
    //     placeholder: inputWrapper.placeholder.value
    // };
